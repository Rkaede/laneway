...
- Output the cards you create as semicolon delimited CSV
- Don't include the CSV header.
- Put the question in the first column, and the answer in the second. 
- Do not output warnings or notes—just the requested sections.
- Wrap the CSV data in triple backticks (```csv) 
